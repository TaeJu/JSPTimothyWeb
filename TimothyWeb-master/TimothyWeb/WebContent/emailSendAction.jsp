...
<%
	...
	// 사용자에게 보낼 내용
	String host = "http://localhost:8080/TimothyWeb/";
	String from = "ltj8316@gmail.com";
	String to = userDAO.getUserEmail(userID);
	String subject = "디모데 웹 가입을 위한 검증 메일입니다.";
	String content = "다음 링크에 접속하여 이메일 확인을 해주세요" + "<a href='" + host + "emailCheckAction.jsp?code=" + new SHA256().getSHA256(to) + "'>이메일 인증 하기</a>";
  ...
  <body>
      ...
      <div class="collapse navbar-collapse" id="navbar">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdown">
              <a class="dropdown-item" href="userRideRequest.jsp">라이드신청</a>
    ...
    <div class="container">
    	<div class="alert alert-success mt-4" role="alert">
    		이메일 주소 인증 메일이 전송되었습니다. 이메일에 들어가셔서 인증해수제요.
    	</div>
    </div>
